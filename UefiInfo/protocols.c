...
// #include "efiusbinitprotocol.h" // QC Specific
...
PROTOCOL_INFO ProtocolArray[EFI_MAX_PROTOCOL_INDEX] = {
    ...
    [EFI_SIMPLE_TEXT_INPUT_PROTOCOL_INDEX]                = PROTO(&gEfiSimpleTextInProtocolGuid, t("EFI_SIMPLE_TEXT_INPUT_PROTOCOL")),
    [EFI_SIMPLE_TEXT_INPUT_EX_PROTOCOL_INDEX]             = PROTO(&gEfiSimpleTextInputExProtocolGuid, t("EFI_SIMPLE_TEXT_INPUT_EX_PROTOCOL")),
    [EFI_SIMPLE_TEXT_OUTPUT_PROTOCOL_INDEX]               = PROTO(&gEfiSimpleTextOutProtocolGuid, t("EFI_SIMPLE_TEXT_OUTPUT_PROTOCOL")),
    ...
    [EFI_DISK_IO_PROTOCOL_INDEX]                          = PROTO(&gEfiDiskIoProtocolGuid, t("EFI_DISK_IO_PROTOCOL")),
    [EFI_DISK_IO2_PROTOCOL_INDEX]                         = PROTO(&gEfiDiskIo2ProtocolGuid, t("EFI_DISK_IO2_PROTOCOL")),
    [EFI_BLOCK_IO_PROTOCOL_INDEX]                         = PROTO(&gEfiBlockIoProtocolGuid, t("EFI_BLOCK_IO_PROTOCOL")),
    [EFI_BLOCK_IO2_PROTOCOL_INDEX]                        = PROTO(&gEfiBlockIo2ProtocolGuid, t("EFI_BLOCK_IO2_PROTOCOL")),
    ...
    [EFI_USBFN_IO_PROTOCOL_INDEX]                         = PROTO(&gEfiUsbFunctionIoProtocolGuid, t("EFI_USBFN_IO_PROTOCOL")),
    // [EFI_USB_INIT_PROTOCOL_INDEX]                      = PROTO(&gEfiUsbInitProtocolGuid, t("EFI_USB_INIT_PROTOCOL")), // QC Specific
    ...
    [EFI_UNICODE_COLLATION_PROTOCOL_INDEX]                = PROTO(&gEfiUnicodeCollation2ProtocolGuid, t("EFI_UNICODE_COLLATION_PROTOCOL")),
    ...
    [EFI_WIRELESS_MAC_CONNECTION_PROTOCOL_INDEX]          = PROTO(&gEfiWiFiProtocolGuid, t("EFI_WIRELESS_MAC_CONNECTION_PROTOCOL")),
    [EFI_WIRELESS_MAC_CONNECTION_II_PROTOCOL_INDEX]       = PROTO(&gEfiWiFi2ProtocolGuid, t("EFI_WIRELESS_MAC_CONNECTION_II_PROTOCOL")),
    ...
    // [EFI_HII_FONT_EX_PROTOCOL_INDEX]                   = PROTO(&gEfiHiiFontExProtocolGuid, t("EFI_HII_FONT_EX_PROTOCOL")), // TODO: Could not find this
    ...
    // [EFI_HII_FONT_GLYPH_GENERATOR_PROTOCOL_INDEX]      = PROTO(&gEfiHiiFontGlyphGeneratorProtocolGuid, t("EFI_HII_FONT_GLYPH_GENERATOR_PROTOCOL")), // TODO: Could not find this
    ...
    [EDKII_VARIABLE_LOCK_PROTOCOL_INDEX]                  = PROTO(&gEdkiiVariableLockProtocolGuid, t("EDKII_VARIABLE_LOCK_PROTOCOL")),
    // clang-format on
};
                           ...
                           OUT EFI_SERVICE_BINDING_PROTOCOL** ServiceBindingProtocol)
{
    ...
    EFI_SERVICE_BINDING_PROTOCOL* LocalServiceBindingProtocol = NULL;
    ...
    Status = gBS->OpenProtocol(DeviceHandle,
                               ...
                               (VOID**)&LocalServiceBindingProtocol,
                               gImageHandle,
                               NULL,
    ...
    *ServiceBindingProtocol = LocalServiceBindingProtocol;

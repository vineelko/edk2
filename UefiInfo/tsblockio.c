...
static VOID EFIAPI TimerCallback(IN EFI_EVENT Event, IN VOID* BlockIo2RWContext)
{
...
static EFI_STATUS UefiInfoBlockIo(IN EFI_BLOCK_IO_PROTOCOL* BlockIoIf)
{
...
static EFI_STATUS BlockIoLargestBlockReadWriteTest(IN PUEFIINFO_SESSION Session)
{
...
static EFI_STATUS BlockIoProbeInfo(IN PUEFIINFO_SESSION Session)
{
    CHAR16* DevicePath = NULL;
    EFI_BLOCK_IO_MEDIA* BlockIoMedia = NULL;
    EFI_BLOCK_IO_PROTOCOL* BlockIoIf = NULL;
...
static EFI_STATUS BlockIoProbeSFSInfo(IN PUEFIINFO_SESSION Session)
{
    CHAR16* DevicePath = NULL;
    EFI_BLOCK_IO_MEDIA* BlockIoMedia = NULL;
    EFI_BLOCK_IO_PROTOCOL* BlockIoIf = NULL;
...
static EFI_STATUS BlockIoAPITest(IN PUEFIINFO_SESSION Session)
{
    EFI_HANDLE* BlockIoHandles = NULL;
    EFI_BLOCK_IO_PROTOCOL* BlockIoIf = NULL;
    UINTN HandleCount = 0;
...
EFI_STATUS
BlockIoWriteToAllSectors(IN PUEFIINFO_SESSION Session);

static EFI_STATUS BlockIoDiskErase(IN PUEFIINFO_SESSION Session)
{
    CHAR16* DevicePath = NULL;
    EFI_BLOCK_IO_MEDIA* BlockIoMedia = NULL;
    EFI_BLOCK_IO_PROTOCOL* BlockIoIf = NULL;
...
UEFIINFO_TEST_SUITE BlockIoTestSuite = {

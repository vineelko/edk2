...
static EFI_STATUS HashProbe(IN PUEFIINFO_SESSION Session)
{
...
static EFI_STATUS Hash1Performance(IN PUEFIINFO_SESSION Session)
{
    EFI_STATUS Status = EFI_SUCCESS;
    EFI_HASH_PROTOCOL* HashProtocol = NULL;
    EFI_HASH_OUTPUT Output;
...
static EFI_STATUS Hash2Performance(IN PUEFIINFO_SESSION Session)
{
    EFI_STATUS Status = EFI_SUCCESS;
    EFI_HASH2_PROTOCOL* Hash2Protocol = NULL;
    EFI_HASH2_OUTPUT Output;
...
#if 0
static EFI_STATUS HashSoftwarePerformance(IN PUEFIINFO_SESSION Session)
{
    EFI_STATUS Status = EFI_SUCCESS;
    VOID* Data = NULL;
    UINTN DataSize = 0;
    UINTN MaxDataSize = 0;
    EFI_EVENT TimerEvent = NULL;
    UINT8 CalculatedHash[RTL_MAX_HASH_LEN_V2];
    CRYPT_DER_BLOB Blobs[1];
    ULONG HashSize = 0;
    NTSTATUS NtStatus;
...
UEFIINFO_TEST_SUITE HashTestSuite = {

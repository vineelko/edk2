...
VOID DumpGuid(IN const EFI_GUID* Guid)
{
    ...
    DBG_INFO("%8x-%4x-%4x-%2x-%2x-%2x-%2x-%2x-%2x-%2x-%2x",
            Guid->Data1, 
            Guid->Data2,
            Guid->Data3, 
            Guid->Data4[0],
...
static CHAR8*
StringByIndex(IN CHAR8* StartAddrPtr,
...
GUID_NAME*
FindGuidNameEntry(IN EFI_GUID* Guid)
{
               ...
               IN CHAR8* ArgName)
{
    ...
    AsciiStrnCpyS(RetArgValue, ArgValueLen + 1, ArgValue, ArgValueLen);

...
static EFI_STATUS SmbiosDumpTables(IN PUEFIINFO_SESSION Session)
{
    ...
    // still deviate from the PI 1.7 Specification(Vol 5).
    //
...
static EFI_STATUS SmbiosDumpType0Table(IN PUEFIINFO_SESSION Session)
{
    EFI_STATUS Status = EFI_SUCCESS;
    EFI_SMBIOS_PROTOCOL* SmbiosProtocol = NULL;
    EFI_SMBIOS_TABLE_HEADER* SmbiosTableHeader = NULL;
    ...
    DBG_INFO("OFFSET_OF(SMBIOS_TABLE_TYPE0, SystemBiosMajorRelease)", OFFSET_OF(SMBIOS_TABLE_TYPE0, SystemBiosMajorRelease));
    DBG_INFO("OFFSET_OF(SMBIOS_TABLE_TYPE0, SystemBiosMinorRelease)", OFFSET_OF(SMBIOS_TABLE_TYPE0, SystemBiosMinorRelease));
Exit:
...
UEFIINFO_TEST_SUITE SmbiosTestSuite = {

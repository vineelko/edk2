...
typedef struct _UEFIINFO_UDP4_SOCKET {
...
} UEFIINFO_UDP4_SOCKET, *PUEFIINFO_UDP4_SOCKET;

typedef struct _UEFIINFO_UDP4_LOOPBACK_CONTEXT {
    UEFIINFO_UDP4_SOCKET Client;
    UEFIINFO_UDP4_SOCKET Server;
...
} UEFIINFO_UDP4_LOOPBACK_CONTEXT, *PUEFIINFO_UDP4_LOOPBACK_CONTEXT;
...
{
    PUEFIINFO_UDP4_LOOPBACK_CONTEXT LoopbackContext = Context;
    PUEFIINFO_UDP4_SOCKET Client = &LoopbackContext->Client;
    PUEFIINFO_UDP4_SOCKET Server = &LoopbackContext->Server;
...
static EFI_STATUS Udp4TransmitAndReceiveData(IN PUEFIINFO_UDP4_LOOPBACK_CONTEXT LoopbackContext)
{
    EFI_STATUS Status = EFI_SUCCESS;
    UINTN Index = 0;
...
static EFI_STATUS Udp4ConfigureClient(IN PUEFIINFO_UDP4_LOOPBACK_CONTEXT LoopbackContext)
{
    EFI_STATUS Status = EFI_SUCCESS;
    PUEFIINFO_UDP4_SOCKET Client = &LoopbackContext->Client;
...
static EFI_STATUS Udp4ConfigureServer(IN PUEFIINFO_UDP4_LOOPBACK_CONTEXT LoopbackContext)
{
    EFI_STATUS Status = EFI_SUCCESS;
    PUEFIINFO_UDP4_SOCKET Server = &LoopbackContext->Server;
...
static VOID Udp4FreeLoopbackContext(IN PUEFIINFO_UDP4_LOOPBACK_CONTEXT LoopbackContext)
{
    PUEFIINFO_UDP4_SOCKET Client = &LoopbackContext->Client;
    PUEFIINFO_UDP4_SOCKET Server = &LoopbackContext->Server;
...
static EFI_STATUS Udp4pLoopbackClientServerTest(IN PUEFIINFO_SESSION Session)
{
    EFI_STATUS Status = EFI_SUCCESS;
    UEFIINFO_UDP4_LOOPBACK_CONTEXT LoopbackContext;
    PUEFIINFO_UDP4_SOCKET Client = &LoopbackContext.Client;
    PUEFIINFO_UDP4_SOCKET Server = &LoopbackContext.Server;
...
extern EFI_STATUS Udp4DirectDutHostSendReceiveTest(IN PUEFIINFO_SESSION Session);

extern EFI_STATUS Udp4DirectDutHostPerfTest(IN PUEFIINFO_SESSION Session);
...
UEFIINFO_TEST_SUITE Udp4TestSuite = {

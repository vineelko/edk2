...
static EFI_STATUS GraphicsOutputProbe(IN PUEFIINFO_SESSION Session)
{
...
extern EFI_STATUS GraphicsOutputRGB(IN PUEFIINFO_SESSION Session);
...
UEFIINFO_TEST_SUITE GraphicsOutputTestSuite = {

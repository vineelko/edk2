...
static EFI_STATUS EFIAPI HttpGetResponse(IN OUT PHTTP_CONTEXT Context,
                                         IN OUT PHTTP_RESPONSE Response);
static EFI_STATUS EFIAPI HttpPoll(IN PHTTP_CONTEXT Context,
                                  IN BOOLEAN* StateVariable,
                                  IN UINTN TimeoutInNs);
static VOID EFIAPI HttpDumpHeaders(IN EFI_HTTP_MESSAGE* Message);
static EFI_STATUS EFIAPI HttpReadHeaders(IN PHTTP_RESPONSE Response);
...
UINT8* EFIAPI HttpGetChunk(IN PHTTP_RESPONSE Response);
...
static EFI_STATUS HttpCreateResponseObject(IN OUT PHTTP_CONTEXT Context,
                                           IN EFI_HTTP_METHOD Method,
                                           OUT PHTTP_RESPONSE* Response)
{
    EFI_STATUS Status = EFI_SUCCESS;
    ...
    if (Method == HttpMethodHead) {
        ...
        if (RetResponse->Message.Body == NULL) {
            Status = EFI_OUT_OF_RESOURCES;
            DBG_ERROR("AllocatePool() failed to allocate %llu bytes for http response",
...
static VOID HttpFreeRequest(IN PHTTP_CONTEXT Context, IN PHTTP_REQUEST Request)
{
    //
...
static EFI_STATUS HttpGetRequest(IN PUEFIINFO_SESSION Session)
{
    EFI_STATUS Status = EFI_SUCCESS;
...
static EFI_STATUS HttpsGetRequest(IN PUEFIINFO_SESSION Session)
{
    EFI_STATUS Status = EFI_SUCCESS;
    PHTTP_CONTEXT HttpContext = NULL;
    PHTTP_RESPONSE Response = NULL;
...
static EFI_STATUS HttpHeadRequest(IN PUEFIINFO_SESSION Session)
{
    EFI_STATUS Status = EFI_SUCCESS;
    PHTTP_CONTEXT HttpContext = NULL;
    PHTTP_RESPONSE Response = NULL;
...
static EFI_STATUS HttpsHeadRequest(IN PUEFIINFO_SESSION Session)
{
    EFI_STATUS Status = EFI_SUCCESS;
    PHTTP_CONTEXT HttpContext = NULL;
    PHTTP_RESPONSE Response = NULL;
...
static EFI_STATUS HttpPostRequest(IN PUEFIINFO_SESSION Session)
{
    EFI_STATUS Status = EFI_SUCCESS;
    PHTTP_CONTEXT HttpContext = NULL;
    PHTTP_RESPONSE Response = NULL;
...
static EFI_STATUS HttpsPostRequest(IN PUEFIINFO_SESSION Session)
{
    EFI_STATUS Status = EFI_SUCCESS;
    PHTTP_CONTEXT HttpContext = NULL;
    PHTTP_RESPONSE Response = NULL;
...
static EFI_STATUS HttpsPostTLSECCRequest(IN PUEFIINFO_SESSION Session)
{
    EFI_STATUS Status = EFI_SUCCESS;
    PHTTP_CONTEXT HttpContext = NULL;
    PHTTP_RESPONSE Response = NULL;
...
UEFIINFO_TEST_SUITE HttpTestSuite = {

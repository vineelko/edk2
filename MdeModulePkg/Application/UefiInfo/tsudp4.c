...
static EFI_STATUS Udp4TransmitAndReceiveData(IN PBM_UDP4_LOOPBACK_CONTEXT LoopbackContext)
{
    EFI_STATUS Status = EFI_SUCCESS;
    UINTN Index = 0;
...
static EFI_STATUS Udp4ConfigureClient(IN PBM_UDP4_LOOPBACK_CONTEXT LoopbackContext)
{
    EFI_STATUS Status = EFI_SUCCESS;
    PBM_UDP4_SOCKET Client = &LoopbackContext->Client;
...
static EFI_STATUS Udp4ConfigureServer(IN PBM_UDP4_LOOPBACK_CONTEXT LoopbackContext)
{
    EFI_STATUS Status = EFI_SUCCESS;
    PBM_UDP4_SOCKET Server = &LoopbackContext->Server;
...
static VOID Udp4FreeLoopbackContext(IN PBM_UDP4_LOOPBACK_CONTEXT LoopbackContext)
{
    PBM_UDP4_SOCKET Client = &LoopbackContext->Client;
    PBM_UDP4_SOCKET Server = &LoopbackContext->Server;

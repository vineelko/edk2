...
static EFI_STATUS Udp4TransmitAndReceiveData(IN PBM_UDP4_CONTEXT Context)
{
...
static EFI_STATUS Udp4ConfigureClient(IN PBM_UDP4_CONTEXT Context)
{
    EFI_STATUS Status = EFI_SUCCESS;
    PBM_UDP4_SOCKET Client = &Context->Client;
...
static VOID Udp4FreeContext(IN PBM_UDP4_CONTEXT Context)
{
    PBM_UDP4_SOCKET Client = &Context->Client;
...
EFI_STATUS
Udp4DirectDutHostPerfTest(IN PBM_PROTOCOL_INFO ProtocolArray, IN PBM_SESSION Session)
{
    EFI_STATUS Status = EFI_SUCCESS;

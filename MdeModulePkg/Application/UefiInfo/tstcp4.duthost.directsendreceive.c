...
static EFI_STATUS Tcp4ConnectToServer(IN PBM_TCP4_CONTEXT Context)
{
...
static EFI_STATUS Tcp4TransmitAndReceiveData(IN PBM_TCP4_CONTEXT Context)
{
    EFI_STATUS Status = EFI_SUCCESS;
    UINTN Index = 0;
...
static EFI_STATUS Tcp4ConfigureClient(IN PBM_TCP4_CONTEXT Context)
{
    EFI_STATUS Status = EFI_SUCCESS;
    PBM_TCP4_CLIENT Client = &Context->Client;
...
static VOID Tcp4FreeContext(IN PBM_TCP4_CONTEXT Context)
{
    PBM_TCP4_CLIENT Client = &Context->Client;

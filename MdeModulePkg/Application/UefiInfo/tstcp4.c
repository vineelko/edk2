...
static EFI_STATUS Tcp4AcceptConnections(IN PBM_TCP4_LOOPBACK_CONTEXT LoopbackContext)
{
    EFI_STATUS Status = EFI_SUCCESS;
    PBM_TCP4_SERVER Server = &LoopbackContext->Server;
...
static EFI_STATUS Tcp4ConnectToServer(IN PBM_TCP4_LOOPBACK_CONTEXT LoopbackContext)
{
    EFI_STATUS Status = EFI_SUCCESS;
    PBM_TCP4_CLIENT Client = &LoopbackContext->Client;
...
static EFI_STATUS Tcp4TransmitAndReceiveData(IN PBM_TCP4_LOOPBACK_CONTEXT LoopbackContext)
{
    EFI_STATUS Status = EFI_SUCCESS;
    UINTN Index = 0;
...
static EFI_STATUS Tcp4ConfigureClient(IN PBM_TCP4_LOOPBACK_CONTEXT LoopbackContext)
{
    EFI_STATUS Status = EFI_SUCCESS;
    PBM_TCP4_CLIENT Client = &LoopbackContext->Client;
...
static EFI_STATUS Tcp4ConfigureServer(IN PBM_TCP4_LOOPBACK_CONTEXT LoopbackContext)
{
    EFI_STATUS Status = EFI_SUCCESS;
    PBM_TCP4_SERVER Server = &LoopbackContext->Server;
...
static VOID Tcp4FreeLoopbackContext(IN PBM_TCP4_LOOPBACK_CONTEXT LoopbackContext)
{
    PBM_TCP4_CLIENT Client = &LoopbackContext->Client;
    PBM_TCP4_SERVER Server = &LoopbackContext->Server;

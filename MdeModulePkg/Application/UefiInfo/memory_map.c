...
EFI_STATUS EFIAPI MemoryMapGetDescriptors(IN MEMORYMAP_CONTEXT* MemoryMapContext,
                                          IN OUT EFI_MEMORY_DESCRIPTOR* MemoryMapBuffer,
                                          IN OUT UINTN* MemoryMapBufferLength,
...
EFI_STATUS EFIAPI MemoryMapGetLargestRegion(IN MEMORYMAP_CONTEXT* MemoryMapContext,

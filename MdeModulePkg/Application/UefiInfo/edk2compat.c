...
BOOLEAN EFIAPI IsGuidEmpty(IN const EFI_GUID* Guid)
{
...
//
CHAR8* EFIAPI IntegerToString(IN INTN Number,
                              IN UINTN Radix,
...
static VOID EFIAPI TimerWaitCallback(IN EFI_EVENT Event, IN PVOID Context)
{

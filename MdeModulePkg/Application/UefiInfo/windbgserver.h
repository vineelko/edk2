...
typedef EFI_STATUS(EFIAPI* EFI_MS_WINDBG_SERVER_PRINT)(IN PEFI_MS_WINDBG_SERVER_PROTOCOL This,
                                                       IN CHAR8* String);
...
typedef EFI_STATUS(EFIAPI* EFI_MS_WINDBG_SERVER_DUMP_IMAGE_INFO)(IN PEFI_MS_WINDBG_SERVER_PROTOCOL
                                                                     This,
